...
- 后端 schema：`backend/app/schemas/schemas.py`
...
- `frontend/src/components/CharacterInterview.tsx`
...
- `backend/app/api/pitch.py`
- `backend/app/services/pitch_service.py`
- `frontend/src/components/PitchGenerator.tsx`
- 可选：`frontend/src/pages/SharePage.tsx`
...
- `frontend/src/components/AuthorStylePanel.tsx`
...
- `backend/app/api/promotion.py`
- `backend/app/services/promotion_service.py`
- `frontend/src/components/PromotionPanel.tsx`
...
- API 调用统一封装到 `frontend/src/services/api.ts`。
- TypeScript 类型统一维护在 `frontend/src/types/index.ts`。
